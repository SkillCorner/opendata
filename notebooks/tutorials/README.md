...
| [**Part 3: Off-ball Runs & Pitch Viz**](02_Working_with_Game_Intelligence_and_Dynamic_Events/Part3_Offball_Runs_Pitch_visualization.ipynb)                                                 | Visualizing runs and positioning on the pitch using dynamic event level data. |
| [**Part 4: Merging Events & Tracking**](02_Working_with_Game_Intelligence_and_Dynamic_Events/Part4_Merging_Dynamic_Events_and_Tracking_Data_Tutorial.ipynb)                                | Synchronizing dynamic event data with continuous tracking streams. |
